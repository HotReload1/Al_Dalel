...
abstract class Styles {
  ...
  static final inputDecorationStyleOutLineBorder = InputDecoration(
    contentPadding: EdgeInsets.symmetric(horizontal: 10),
    filled: true,
    border: OutlineInputBorder(
      borderSide: BorderSide(
